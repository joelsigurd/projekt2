...
public class XLMenuBar extends JMenuBar {
    public XLMenuBar(XL xl, XLList xlList, StatusLabel statusLabel, CellEnvironment sheet, CurrentSlot currentSlot) {
        ...
        edit.add(new ClearMenuItem(currentSlot, sheet, statusLabel));
